...
if (!$userId) {
    echo json_encode(['status' => 'error', 'message' => 'A valid account is required to update.']);
    exit;
}
...
$data = [
    ...
    'password' => $_POST['password'] ?? '', // optional on update — blank keeps the current password
