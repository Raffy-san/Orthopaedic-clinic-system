...
<body class="w-full min-h-screen bg-gray-50">
    <main>
        ...
        <section id="roleSelection" class="flex h-screen">
            <!-- Left Section -->
            <div class="hidden lg:flex lg:w-2/5 bg-gradient-to-br from-blue-950 to-blue-900 flex-col justify-center px-12 py-8">
                <div class="max-w-md">
                    <h1 class="text-white text-5xl font-bold leading-tight mb-4">Southern Leyte<br>Orthopaedic<br>Clinic</h1>
                    <p class="text-blue-100 text-base leading-relaxed mb-8">
                        Integrated clinic management — patients can book appointments online while staff manage consultations, billing, and reports.
                    </p>
                    <div class="space-y-4">
                ...
                <div class="w-full max-w-md">
                    ...
                    <div class="mb-12 text-center">
                        <div class="flex justify-center mb-4">
                            <img src="assets/img/logo.jpg" alt="SLOC Logo" class="w-16 h-16 rounded-full object-cover">
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Admin Button -->
                        <button onclick="selectRole('admin')" class="w-full p-6 border-2 border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition group">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="text-left">
                                    <h3 class="font-bold text-gray-800 text-lg">Admin / Staff</h3>
                                    <p class="text-gray-500 text-sm">Manage clinic operations and patient records</p>
                                </div>
                                <i class="fa-solid fa-arrow-right text-blue-600 ml-auto opacity-0 group-hover:opacity-100 transition"></i>
                            </div>
                        </button>

                        <!-- Patient Button -->
                        <button onclick="selectRole('patient')" class="w-full p-6 border-2 border-gray-300 rounded-lg hover:border-teal-500 hover:bg-teal-50 transition group">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="text-left">
                                    ...
                                    <p class="text-gray-500 text-sm">Book appointments and manage your health records</p>
                                </div>
                                <i class="fa-solid fa-arrow-right text-teal-600 ml-auto opacity-0 group-hover:opacity-100 transition"></i>
                            </div>
                        </button>
                    </div>
                </div>
        ...
        <section id="adminScreen" class="flex h-screen hidden">
            ...
            <div class="w-full lg:w-3/5 flex flex-col justify-center items-center px-6 py-8">
                <div class="w-full max-w-md">
                    <!-- Back Button -->
                    <button onclick="backToRoleSelection()" class="mb-6 text-gray-600 hover:text-gray-800 flex items-center gap-2 text-sm">
                    ...
                    <form class="space-y-5" onsubmit="event.preventDefault();">
                        ...
                        <div>
                            <label class="block text-gray-700 text-sm font-semibold mb-2" for="adminPassword">Password</label>
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    type="password" name="adminPassword" id="adminPassword" placeholder="Enter your password"
                                    required>
                        ...
                        <button class="bg-blue-600 text-white py-2.5 px-4 rounded-lg hover:bg-blue-700 active:bg-blue-800 w-full mt-8 font-semibold transition shadow-md hover:shadow-lg"
        ...
        <section id="patientScreen" class="flex h-screen hidden">
            ...
            <div class="w-full lg:w-3/5 flex flex-col justify-center items-center px-6 py-8">
                <div class="w-full max-w-md">
                    ...
                    <form class="space-y-5" onsubmit="event.preventDefault();">
                        <div>
                            <label class="block text-gray-700 text-sm font-semibold mb-2" for="patientId">Patient ID</label>
                            <div class="relative">
                                ...
                                <input
                                    ...
                                    type="text" name="patientId" id="patientId" placeholder="PT-YYYY-XXXX"
                                    required>
                            </div>
                        </div>

                        <div>
                            <label class="block text-gray-700 text-sm font-semibold mb-2" for="patientPassword">Password</label>
                            <div class="relative">
                                <i class="fa-solid fa-lock absolute left-3 top-3.5 text-gray-400 text-sm"></i>
                                <input
                                    ...
                                    type="password" name="patientPassword" id="patientPassword" placeholder="Enter your password"
                                    required>
                        ...
                        <button class="bg-teal-600 text-white py-2.5 px-4 rounded-lg hover:bg-teal-700 active:bg-teal-800 w-full mt-8 font-semibold transition shadow-md hover:shadow-lg"
                            type="submit" onclick="window.location.href='users/user-dashboard.php';">Sign In as Patient</button>
                    </form>

                    <!-- Register Link -->
                    <p class="text-center text-gray-600 text-sm mt-6">
                        Not registered yet? <a href="#" class="text-teal-600 font-semibold hover:text-teal-700 transition">Contact the clinic to register</a>
                    </p>
                </div>
            </div>
        </section>
